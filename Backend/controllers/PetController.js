...
module.exports = class PetController {
    ...
    static async removePetById(req, res) 
    {
        ...
        // Verificando se o usuario logado resgistrou o pet
        const token = getToken(req)
        const user = await getUserByToken(token)
    ...
    static async schedule(req, res) {
        ...
        // Verificando se o pet é do proprio usuario
        const token = getToken(req)
        const user = await getUserByToken(token)
        ...
        // Verificando se o usuario já fez um agendamento de visita
        if (pet.adopter) {
        ...
        // Adicionar o usuario como adotante do pet
        pet.adopter = {
            _id: user._id,
            name: user.name,
            image: user.image
